...
function installThunderboltDependencies(python) {
  ...
  installRequirementIfNeeded(join(root, "requirements.txt"), "thunderbolt_requirements_sha256", ["streamlit", "requests", "pandas", "toml", "imageio_ffmpeg", "edge_tts", "google.auth", "google_auth_oauthlib", "googleapiclient", "yt_dlp", "instaloader", "deno", "youtube_transcript_api", "huggingface_hub", "playwright"], "Thunderbolt");
