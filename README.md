...
| AI Influencers | Menu expansível com Personagens, Geração de Conteúdo IA, Redes Sociais, Tutorial Meta e Tutorial Supabase; Personagens aceita múltiplas imagens e documentos `.md`/`.json`, e Geração de Conteúdo IA separa Imagens, Vídeos e Motion Control |
