...
class NavigationReorganizationTests(unittest.TestCase):
    ...
    def test_google_accounts_are_moved_to_api_settings_subtab(self):
        ...
        self.assertIn('api_keys_tab, google_accounts_tab, tiktok_api_tab, ai_influencers_tab, voice_test_tab = render_localized_tabs(["API Keys", "Contas Google", "API Tiktok", "AI Influencers", "Teste de Voz"])', MAIN_SOURCE)
