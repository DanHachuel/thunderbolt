...
class ApiSettingsExpandersTests(unittest.TestCase):
    ...
    def test_llm_and_media_sections_are_in_main_list_after_apify(self):
        ...
        self.assertNotIn('Provider principal de imagem', MAIN_SOURCE)
        self.assertNotIn('Provider principal de vídeo', MAIN_SOURCE)
        self.assertNotIn('Usar pool de vídeo externo', MAIN_SOURCE)
