...
def test_api_keys_contains_material_sources_subtab_with_multi_key_controls():
    ...
    assert 'api_keys_tab, voice_test_tab = render_localized_tabs(["API Keys", "Teste de vozes"])' in settings_page
    assert 'api_service_tab, material_sources_tab = render_localized_tabs(["Serviços e modelos", "Fontes de materiais"])' in settings_page
